...
public class DBInitializer 
{
    ...
    {
        using var scope = app.Services.CreateScope(); //Purpose of using key. is it dispose after run
    ...
    private static void SeedData(AuctionDBContext context)
    {
       ...
       if(context.Auctions.Any()) //Determines whether a sequence contains any elements in Auctions table.
       {
            Console.WriteLine("Already filled with data -- No need to seed");
            return;
       }
